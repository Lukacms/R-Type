 ...
 */
void rserver::Manager::shoot_according_level(rserver::Player &player)
{
    auto &component{
        this->ecs.get_class().get_component<rtype::TransformComponent>(player.get_entity_value())};

    if (player.get_level() == 1) {
        size_t bullet_id{ServerEntityFactory::create("PlayerBullet", this->ecs.get_class())};
        ...
        size_t bullet_id1{ServerEntityFactory::create("PlayerBullet", this->ecs.get_class())};
        size_t bullet_id2{ServerEntityFactory::create("PlayerBullet", this->ecs.get_class())};
        auto &transform_bullet1{
            this->ecs.get_class().get_component<rtype::TransformComponent>(bullet_id1)};
        auto &transform_bullet2{
            this->ecs.get_class().get_component<rtype::TransformComponent>(bullet_id2)};
        ...
        size_t bullet_id1{ServerEntityFactory::create("PlayerBullet", this->ecs.get_class())};
        size_t bullet_id2{ServerEntityFactory::create("PlayerBullet", this->ecs.get_class())};
        size_t bullet_id3{ServerEntityFactory::create("PlayerBullet", this->ecs.get_class())};
        auto &transform_bullet1{
            this->ecs.get_class().get_component<rtype::TransformComponent>(bullet_id1)};
        auto &transform_bullet2{
            this->ecs.get_class().get_component<rtype::TransformComponent>(bullet_id2)};
        auto &transform_bullet3{
            this->ecs.get_class().get_component<rtype::TransformComponent>(bullet_id3)};
        transform_bullet1.position_x = component.position_x + POSITION_CHANGE;
        transform_bullet1.position_y = component.position_y + OFFSET_Y_BULLET;
        transform_bullet2.position_x = component.position_x + POSITION_CHANGE;
        transform_bullet2.position_y = component.position_y;
